...
// Form validation schema for staff signup
...
const StaffSignupPage = () => {
  ...
  const onSubmit = async (data: SignupFormValues) => {
    setLoading(true);
    try {
      // Format email if not provided with domain
      ...
      >
        <div className="h-full w-full bg-nmca-blue/50 backdrop-blur-sm flex items-center justify-center">
          <div className="max-w-md text-white p-8">
            <h1 className="text-4xl font-bold mb-4">Join NMCA as Staff</h1>
            <p className="text-xl">Help shape the future of auditing education.</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Create your staff account to access teaching resources</CardDescription>
            </CardHeader>
